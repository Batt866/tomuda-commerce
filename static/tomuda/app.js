...
.receipt-grid__spacer--sign-gap td { height: 16px; padding: 0; }
...
// ҮНДСЭН A–K: A нарийн gutter; B fits «Дансны дугаар:»; C free for bank row
...
function appendReceiptSheetRows(o, ctx, rows, merges, startRow = 1) {
  ...
  merges.push(
    ...
    `B${bankR3}:C${bankR3}`,
    `D${bankR3}:E${bankR3}`,
    // Same as other bank labels: B:C = Дансны дугаар:; D:E = IBAN + short; next = account
    `B${bankR4}:C${bankR4}`,
    `D${bankR4}:E${bankR4}`,
    `D${bankR5}:E${bankR5}`,
  );
