...
function appendReceiptSheetRows(o, ctx, rows, merges, startRow = 1) {
  ...
  merges.push(
    ...
    `B${bankR3}:C${bankR3}`,
    `D${bankR3}:E${bankR3}`,
    // B = Дансны дугаар:; C = IBAN: / numbers stacked below in C
  );
  pushRow(14.25, [
