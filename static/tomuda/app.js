...
function appendReceiptSheetRows(o, ctx, rows, merges, startRow = 1) {
  ...
  merges.push(
    ...
    `B${bankR3}:C${bankR3}`,
    `D${bankR3}:E${bankR3}`,
    // B:C = Дансны дугаар: (normal size); D = IBAN:; E = short number
    `B${bankR4}:C${bankR4}`,
    `D${bankR5}:E${bankR5}`,
  );
  pushRow(14.25, [
